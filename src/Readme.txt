    ...
    * Verify that mapping between models is correct
    * Use connectionstring in appsettings.json in SpecialOperationsMovieService
    * Set startup page to Movies / Index page
